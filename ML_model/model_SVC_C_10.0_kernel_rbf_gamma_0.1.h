                ...
                public:
                    ...
                    */
                    int predict(float *x) {
                        ...
                        float decision = -0.582602400033;
                        decision = decision - ( + kernels[0] * -0.479220464617  + kernels[1] * -0.489655455051  + kernels[2] * -0.436551490965  + kernels[3] * -0.462401162437  + kernels[4] * -0.417916754055  + kernels[5] * -0.417685427964  + kernels[6] * -0.417863946732  + kernels[7] * -0.417540712099  + kernels[8] * -0.421724481332  + kernels[9] * -0.449586141502 );
                        decision = decision - ( + kernels[10] * 0.892586414306  + kernels[11] * 0.654504090855  + kernels[12] * 0.482142494863  + kernels[13] * 0.933830207478  + kernels[14] * 1.050865317611  + kernels[15] * 0.396217511643 );
