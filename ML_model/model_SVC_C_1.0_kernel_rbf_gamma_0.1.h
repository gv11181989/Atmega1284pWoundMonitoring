                ...
                public:
                    ...
                    */
                    int predict(float *x) {
                        ...
                        float decision = -0.585091860175;
                        decision = decision - ( + kernels[0] * -0.476929052689  + kernels[1] * -0.487062071453  + kernels[2] * -0.433819253205  + kernels[3] * -0.460694894619  + kernels[4] * -0.415661835791  + kernels[5] * -0.415319953454  + kernels[6] * -0.415678475689  + kernels[7] * -0.414903974398  + kernels[8] * -0.419361094009  + kernels[9] * -0.446704459111 );
                        decision = decision - ( + kernels[10] * 0.893339052184  + kernels[11] * 0.658300026145  + kernels[12] * 0.490925536138  + kernels[13] * 0.938553447027  + kernels[14] * 1.0  + kernels[15] * 0.405017002925 );
